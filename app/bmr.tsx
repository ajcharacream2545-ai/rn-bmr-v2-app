...
// สร้าง state เพื่อ handle ข้อมูลต่างๆ
...
export default function BmrScreen() {
  ...
  const handleCalBMRClick = () => {
    ...
    let bmrValue = 0;
    // คำนวน bmr โดยต้องมีกากรพิสูจน์ เพราะสูตรมันต่างกัน
    if (gender === "male") {
  ...
  //กำหนดค่าให้ค่ากับ State (bmr) เพื่อแสดงผล
